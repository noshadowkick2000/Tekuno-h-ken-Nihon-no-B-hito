...
namespace BezierSolution.Extras
{
    ...
    //private static bool movingPointAlongSpline = false;
    //private static GameObject tempPoint = null;
    //private static BezierSpline splineOfTempPoint = null;
		...
		private void OnSceneGUI()
		{
			...
			switch( Tools.current )
			{
              ...
              if (point.linkedPoint)
              {
                Undo.RecordObject(point.linkedPoint, "Move Control Point");
              }
              ...
              if (point.linkedPoint)
              {
                Undo.RecordObject(point.linkedPoint, "Move Point");
                Undo.RecordObject(point.linkedPoint.transform, "Move Point");
              }
              ...
              point.position = position;
                ...
                if (allPoints[i].linkedPoint)
                {
                  Undo.RecordObject(allPoints[i].linkedPoint, "Move Point");
                  Undo.RecordObject(allPoints[i].linkedPoint.transform, "Move Point");
                }
              ...
              if (point.linkedPoint)
              {
                Undo.RecordObject(point.linkedPoint.transform, "Rotate Point");
              }
              ...
              Vector3 localAxis = point.transform.InverseTransformDirection( axis );
                ...
                if (point.linkedPoint)
                {
                  Undo.RecordObject(allPoints[i].linkedPoint.transform, "Rotate Point");
                }
              ...
              if (point.linkedPoint)
              {
                Undo.RecordObject(point.linkedPoint.transform, "Scale Point");
              }
              ...
              point.localScale = scale;
                ...
                if (point.linkedPoint)
                {
                  Undo.RecordObject(allPoints[i].linkedPoint.transform, "Scale Point");
                }
      ...
      if ( GUILayout.Button( "Decrement Point's Index" ) )
			{
              ...
              if (points[j].linkedPoint)
              {
                Undo.RegisterCompleteObjectUndo(points[j].linkedPoint.transform.parent, "Change point index");
              }
      ...
      EditorGUI.showMixedValue = hasMultipleDifferentValues;
          ...
          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint, "Change Point Handle Mode");
          }
      ...
      if (EditorGUI.EndChangeCheck())
      {
        for (int i = 0; i < allPoints.Length; i++)
        {
          ...
          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint, "Change Point Global Position");
          }
      ...
      hasMultipleDifferentValues = false;
          ...
          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint, "Change Point Position");
          }
          ...
          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint, "Swap Control Points");
          }
      ...
      EditorGUILayout.HelpBox("When assigning a linked point value below, the currently selected point takes the values of the point you assign below.", MessageType.Info, true);

      hasMultipleDifferentValues = false;
      BezierPoint linkedPoint = allPoints[0].linkedPoint;
      for (int i = 1; i < allPoints.Length; ++i)
      {
        if (allPoints[i].linkedPoint != linkedPoint)
        {
          hasMultipleDifferentValues = true;
          break;
        }
      ...
      EditorGUI.showMixedValue = hasMultipleDifferentValues;
      EditorGUI.BeginChangeCheck();
      linkedPoint = (BezierPoint)EditorGUILayout.ObjectField("Linked Point", linkedPoint, typeof(BezierPoint), true);

      if (EditorGUI.EndChangeCheck())
      {
        for (int i = 0; i < allPoints.Length; i++)
        {
          Undo.RecordObject(allPoints[i], "Change Linked Point");
          Undo.RecordObject(allPoints[i].cameraBehaviour, "Change Linked Point");

          if (linkedPoint)
          {
            Undo.RecordObject(linkedPoint, "Change Linked Point");
            Undo.RecordObject(linkedPoint.cameraBehaviour, "Change Linked Point");
          }

          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint, "Change Linked Point");
            Undo.RecordObject(allPoints[i].linkedPoint.cameraBehaviour, "Change Linked Point");
          }

          allPoints[i].linkedPoint = linkedPoint;
        }
      ...
      EditorGUILayout.Space();
          ...
          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint, "Change Extra Data");
          }
          ...
          if (allPoints[i].linkedPoint)
          {
            Undo.RecordObject(allPoints[i].linkedPoint.transform, "Reset Point");
            Undo.RecordObject(allPoints[i].linkedPoint, "Reset Point");
          }
